...
chaat = Meal.create!(name: "Chicken Chaat", price_cents: 580, description: "Chicken breast pieces tossed in a mixture of onions, tomatoes, cucumber, lemon juice & tangy spices", restaurant_id: Restaurant.first.id, category: "Starter" )
...
scallops = Meal.create!(name: "Goan Tawa Scallops", price_cents: 780, description: "Pan-seared scallops flavoured with onions, tomatoes & home-made Goan spices", restaurant_id: Restaurant.first.id, category: "Starter")
...
jalfrezi = Meal.create!(name: "Chicken Jalfrezi", price_cents: 1520, description: "Exotic hot chicken prepared in aromatic spices with capsicum, green chillies & fresh herbs", restaurant_id: Restaurant.first.id, category: "Main")
...
fanta = Meal.create!(name: "Fanta", price_cents: 260, description: "Sweet orange fizzy drink", restaurant_id: Restaurant.first.id, category: "Beverages")
...
kulfi = Meal.create!(name: "Kulfi", price_cents: 460, description: "This spiced, nutty custard is melt-in-your-mouth delicious. Kulfi is very similar to ice cream, but just a tad thicker and creamier.", restaurant_id: Restaurant.first.id, category: "Dessert")
